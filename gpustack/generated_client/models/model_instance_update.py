...
T = TypeVar("T", bound="ModelInstanceUpdate")


@_attrs_define
class ModelInstanceUpdate:
    """
    Attributes:
        model_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        model_instance_update.additional_properties = d
        return model_instance_update
