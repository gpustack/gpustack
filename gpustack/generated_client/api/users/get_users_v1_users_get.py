...
) -> Optional[Union[HTTPValidationError, PaginatedListUserPublic]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, PaginatedListUserPublic]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, PaginatedListUserPublic]
    """
