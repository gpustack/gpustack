...
| `GPUSTACK_RUNTIME_DEPLOY_CDI_SPECS_GENERATE`                                                                         | During deployment, enable automatic generation of Container Device Interface (CDI) specifications for detected devices.                                                                                                                                                                                                                                   | `1`                                             |
