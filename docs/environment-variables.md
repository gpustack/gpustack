...
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_IMAGE_REGISTRY_USERNAME`                                                                               | Username for the default container registry.                                                                                                                                                                                                                                                                                                              | (empty)                                         |
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_REGISTRY_USERNAME` (Deprecated, use `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_IMAGE_REGISTRY_USERNAME` instead) | Username for the default container registry.                                                                                                                                                                                                                                                                                                              | (empty)                                         |
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_IMAGE_REGISTRY_PASSWORD`                                                                               | Password for the default container registry.                                                                                                                                                                                                                                                                                                              | (empty)                                         |
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_REGISTRY_PASSWORD` (Deprecated, use `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_IMAGE_REGISTRY_PASSWORD` instead) | Password for the default container registry.                                                                                                                                                                                                                                                                                                              | (empty)                                         |
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_IMAGE_NAMESPACE`                                                                                       | Namespace for default runner images.                                                                                                                                                                                                                                                                                                                      | `gpustack`                                      |
| `GPUSTACK_RUNTIME_DEPLOY_IMAGE_PULL_POLICY`                                                                                             | Image pull policy for the deployer (e.g., Always, IfNotPresent, Never).                                                                                                                                                                                                                                                                                   | `IfNotPresent`                                  |
| `GPUSTACK_RUNTIME_DEPLOY_RESOURCE_KEY_MAP_CONTAINER_DEVICE_INTERFACES`                                                                  | Manual mapping of container device interfaces, which is used to tell the Container Runtime which devices to inject into the container, e.g., `nvidia.com/devices=nvidia.com/gpu;amd.com/devices=amd.com/gpu`. The key is the resource key, and the value is the Container Device Interface(CDI) key.                                                      | The default values named by each vendor         |
