...
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_REGISTRY_USERNAME` (Deprecated, use `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_CONTAINER_REGISTRY_USERNAME` instead) | Username for the default container registry.                                                                                                                                                                                                                                                                                                              | (empty)                                         |
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_CONTAINER_REGISTRY_PASSWORD`                                                                               | Password for the default container registry.                                                                                                                                                                                                                                                                                                              | (empty)                                         |
| `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_REGISTRY_PASSWORD` (Deprecated, use `GPUSTACK_RUNTIME_DEPLOY_DEFAULT_CONTAINER_REGISTRY_PASSWORD` instead) | Password for the default container registry.                                                                                                                                                                                                                                                                                                              | (empty)                                         |
