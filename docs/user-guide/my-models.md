...
There are three status:
  ...
  - **Active**: The model is running normally.
  - **Stopped**: The model is not running.
  - **Abnormal**: The number of ready replicas does not match the configured replicas.


![my-models](../assets/backends/my-models.png)
