...
| ------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Linux   | AMD64<br>ARM64 | [pip Installation](#pip-installation) |
...
Install GPUStack in Cambricon docker
...
Use Cambricon docker and Activate the "pytorch_infer" virtual environment:
...
Run the following to install GPUStack.
    ...
    ```bash
    # "vllm" has been installed in Cambricon docker
