...
| `--trusted-hosts` value                          | (empty)                                          | Host names allowed in the `X-Forwarded-Host` header behind a reverse proxy. Use `*` to trust any host. When unset, derived from `--server-external-url`.                                                                                                                                                                                      |
