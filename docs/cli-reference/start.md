...
| `--enable-hf-transfer` value        | (empty)                                | Speed up file transfers with the huggingface Hub. https://huggingface.co/docs/huggingface_hub/v0.29.3/package_reference/environment_variables#hfhubenablehftransfer                                                                                                                                                                                                               |
