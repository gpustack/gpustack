...
| `--server-port` value               | `8080`          | Target port of the GPUStack API server for applying or listing runtime config. When omitted, defaults to `GPUSTACK_API_PORT` if set, otherwise `8080`.                                                                                                                                                                                         |
