...
| `--source-namespace`, `--src-namespace` `SOURCE_NAMESPACE`            | (empty)                                | Source namespace in the source registry; for multi-level namespaces, specify parent levels to `--source` and child to `--source-namespace`                     |
...
| `--destination`, `--dest` `DESTINATION`                               | `docker.io`                            | Destination registry                                                                                                                                           |
| `--destination-namespace`, `--dest-namespace` `DESTINATION_NAMESPACE` | (empty)                                | Destination namespace in the destination registry; for multi-level namespaces, specify parent levels to `--destination` and child to `--destination-namespace` |
